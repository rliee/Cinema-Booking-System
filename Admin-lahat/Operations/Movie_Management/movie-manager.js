document.addEventListener("DOMContentLoaded", () => {
    ...
    if (editForm) {
        editForm.addEventListener("submit", (e) => {
            ...
            fetch('/Movie_Booking_System/Admin/Operations/Movie_Management/edit_movie.php', {
                method: 'POST',
                body: formData
            })
    ...
    if (confirmDeleteBtn) {
        confirmDeleteBtn.addEventListener("click", () => {
            ...
            fetch('/Movie_Booking_System/Admin/Operations/Movie_Management/delete_movie.php', {
                method: 'POST',
                body: formData
            })
    ...
    if (addMovieForm) {
        addMovieForm.addEventListener("submit", (e) => {
            ...
            fetch('/Movie_Booking_System/Admin/Operations/Movie_Management/add_movie.php', {
                method: 'POST',
                body: formData
            })
                .then(parseJsonResponse)
...
function fetchMovies() {
    ...
    fetch('/Movie_Booking_System/Admin/Operations/Movie_Management/get_movies.php')
        .then(parseJsonResponse)
        .then(result => {
            if (result.success) {
...
function renderMovies(movies, container) {
    ...
    movies.forEach(movie => {
        ...
        let posterSrc = movie.poster_url && movie.poster_url.trim() !== ''
            ? movie.poster_url
            : 'image.png';
