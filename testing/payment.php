...
<body>
    ...
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="index.php">
        ...
        <div class="d-flex flex-column justify-content-center">
          <span class="fs-4 p-0 m-0 lh-1 fw-bold">Cinema Royale</span>
          <div class="navbar-brand-subtitle ms-1" style="font-size: 0.65rem; letter-spacing: 1px;">PREMIUM EXPERIENCE</div>
        </div>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarMenu">
        ...
        <div class="auth-buttons ms-lg-auto d-flex flex-row justify-content-center my-2">
  ...
  <script>
    ...
    function confirmPayment() {
      ...
      localStorage.setItem("paymentRef", "CR-" + Math.floor(100000 + Math.random() * 900000));
      localStorage.setItem("userRef", refInput);
