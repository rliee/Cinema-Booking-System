    ...
    <script>
        ...
        function loadSelectedSeats() {
            ...
            savedSeats.forEach(label => {
                ...
                const matchingSeat = Array.from(document.querySelectorAll('.seat:not(.taken):not(.unavailable)')).find(s => s.textContent.trim() === label);
                if (matchingSeat) {
        ...
        function toggleSeatSelection(seat) {
            if (!seat || seat.classList.contains('taken') || seat.classList.contains('unavailable')) return;
