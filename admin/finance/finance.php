...
/*PAYMENT RECORDS*/
$payments = $conn->query("SELECT p.transaction_code, c.fullname, m.movie_name, p.payment_method, p.amount, p.payment_date, p.payment_status
        FROM payments p INNER JOIN bookings b ON p.booking_id = b.booking_id INNER JOIN customers c ON b.customer_id = c.customer_id INNER JOIN movies m ON b.movie_id = m.movie_id
